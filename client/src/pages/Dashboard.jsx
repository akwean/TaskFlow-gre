                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                        ...
                        <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
                            <DialogTrigger asChild>
                                <button className="h-32 rounded-xl border-2 border-dashed border-gray-300 hover:border-gray-400 hover:bg-gray-50 transition-all flex items-center justify-center group hover:shadow-sm">
                        ...
                        {boards.map((board) => {
                            const isNew =
                                board.createdAt &&
                                Date.now() - new Date(board.createdAt).getTime() < 60 * 1000;
                            ...
                            return (
                                ...
                                >
                                    {/* NEW BADGE */}
                                    {isNew && (
                                        <span className="absolute top-2 right-2 bg-white/90 text-black text-xs px-2 py-[1px] rounded-full z-20 shadow">
                                            New
                                        </span>
                                    )}
